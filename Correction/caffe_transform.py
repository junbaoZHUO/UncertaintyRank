...
def transform_test(data_transforms=None, resize_size=256, crop_size=224):
  ...
  data_transforms['10crop'] = transforms.Compose([
    transforms.Scale(256),
    transforms.TenCrop(224), # this is a list of PIL Images
    transforms.Lambda(lambda crops: torch.stack([transforms.Normalize((0.485, 0.456, 0.406),(0.229, 0.224, 0.225))(transforms.ToTensor()(crop)) for crop in crops])), # returns a 4D tensor
  ])    
