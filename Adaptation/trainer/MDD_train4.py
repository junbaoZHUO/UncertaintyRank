...
def train(model_instance, train_source_clean_loader, train_source_noisy_loader, train_target_loader, test_target_loader, group_ratios, max_iter, optimizer, lr_scheduler, eval_interval):
    ...
    while True:
        for (datas_clean, datas_noisy, datat) in tqdm.tqdm(
            ...
            total_loss = train_batch(model_instance, inputs_source, labels_source, inputs_target, optimizer, iter_num, max_iter, inputs_source_noisy, WEIGHT)
...
if __name__ == '__main__':
    ...
    from model.MDD2 import MDD
    from preprocess.data_provider_ab1 import load_images
    import pickle
    ...
    lr_scheduler = INVScheduler(gamma=cfg.lr_scheduler.gamma,
                                ...
                                init_lr=cfg.init_lr)
    to_dump = train(model_instance, train_source_clean_loader, train_source_noisy_loader, train_target_loader, test_target_loader, group_ratios, max_iter=args.maxIter, optimizer=optimizer, lr_scheduler=lr_scheduler, eval_interval=1000)
