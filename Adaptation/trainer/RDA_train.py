...
if __name__ == '__main__':
    ...
    from preprocess.data_provider import load_images # practical setting OFF
    from preprocess.data_provider2 import load_images # practical setting O31
    import pickle
