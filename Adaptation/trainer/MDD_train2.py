...
import torch
import sys
sys.path.insert(0, "/data1/junbao/RDA-git")
...
if __name__ == '__main__':
    ...
    # from preprocess.data_provider4 import load_images # provider4 ideal setting
    from preprocess.data_provider3 import load_images  # provider3 practical setting
    import pickle
