...
if __name__ == '__main__':
    ...
    from preprocess.data_provider_bc import load_images  # provider3 practical setting
    import pickle
    ...
    lr_scheduler = INVScheduler(gamma=cfg.lr_scheduler.gamma,
                                ...
                                init_lr=cfg.init_lr)
    to_dump = train(model_instance, train_source_clean_loader, train_source_noisy_loader, train_target_loader, test_target_loader, group_ratios, max_iter=args.maxIter, optimizer=optimizer, lr_scheduler=lr_scheduler, eval_interval=2000)
